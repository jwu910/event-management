...
var Form = function (_JSXComponent) {
	...
	_createClass(Form, [{
		...
		value: function render() {
			...
			IncrementalDOM.elementVoid(_InputField2.default, null, null, 'onChange', this.updateFieldValue, 'prefixText', 'Hello - not default text');
...
var InputField = function (_JSXComponent) {
	...
	_createClass(InputField, [{
		...
		value: function updateFieldValue(event) {
		...
		value: function render() {
			IncrementalDOM.elementOpen('div');
			IncrementalDOM.elementVoid('input', null, null, 'value', this.PROPS.placeHolder, 'cssClass', 'input-field');
			return IncrementalDOM.elementClose('div');
		}
	}]);
...
InputField.PROPS = {
	placeHolder: "Input Field Default Text"
};
